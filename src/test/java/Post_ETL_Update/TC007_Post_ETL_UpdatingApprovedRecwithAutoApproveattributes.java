			        ...
			        try {
						...
						**************************************************/
				        if(preETL_fieldvalue.equals(postETL_Attribvalue)) {
				        	test.info("No change in value for <b>" + fieldLabel + "</b><br>" +
				        	          "Pre-ETL: " + preETL_fieldvalue + "<br>" +
				        	          "Post-ETL: " + postETL_Attribvalue);
				        	...
				        	test.info("Changed value for <b>" + fieldLabel + "</b><br>" +
				        	          "Pre-ETL: " + preETL_fieldvalue + "<br>" +
				        	          "Post-ETL: " + postETL_Attribvalue);
			...
			for (int f = 0; f < searchFields.size(); f++) {
				...
				data.put(Attribute_Text, postETL_Attribvalue);
				 ...
				 if(Attribute_Text.equals(postETL_Attribvalue)) {
			        	test.info("No change in value for <b>" + Attribute_Text + "</b><br>" +
			        	          "Pre-ETL: " + preETL_fieldvalue + "<br>" +
			        	          "Post-ETL: " + postETL_Attribvalue);
			        	...
			        	test.info("Changed value for <b>" + Attribute_Text + "</b><br>" +
			        	          "Pre-ETL: " + preETL_fieldvalue + "<br>" +
			        	          "Post-ETL: " + postETL_Attribvalue);
