...
public class TC_002_Update_BSAPIEPendingUseCaseApproval extends BaseTest{

	public ExtentTest test;
	Map<String, Object> data = new LinkedHashMap<>();
	
	@Test(groups = { "BSAPIEowner" })
	public void UpdatePending_PostETL() throws IOException, InterruptedException {
		...
		/**************************************************
		 * --------- Apply the status filter for "In Progress"------- *
		 ********************************************************/
